...
class Student1 {
	...
	//필드: 접근제어자가 private일 때 외부에서 접근이 불가함
	//getter, setter를 사용해서 접근이 가능함.
	private String name;
	private int stuID;
	private int age;
	...
	//객체 자체를 프린트 할 때 필드의 값 전체를 출력할 수 있도록 toString(): Object 의 메소드
...
public class Initial_Field02 {
	...
	public static void main(String[] args) {
		// 1. 모든 필드의 접근제어자가 private 이므로 필드에 직접접근이 불가.
