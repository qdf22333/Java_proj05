...
class TigerChild extends Animal {
...
public class TypeCasting01 {
	...
	public static void main(String[] args) {
		...
		//2. Tiger 타입으로 객체 생성 : Animal, Tiger 필드와 메소드 모두 접근
		// t3 : Animal, Tiger 모두 내포
		Tiger t3 =new Tiger();
		
		//
		//다운 캐스팅 : 실행시 오류발생, t3에는 TigerChild는 내포하고 있지 않기 때문에
		//다운캐스팅 실행시 오류
...
//		System.out.println(t3 instanceof TigerChild);	//false
		...
		//다운 캐스팅 할 때는 반드시 instanceof 를 사용해야 한다.
...
//		TigerChild t4 = (TigerChild) t3;
		...
		System.out.println(a3 instanceof Animal );	//t
		System.out.println(a3 instanceof Tiger);	//t
		System.out.println(a3 instanceof TigerChild );	//t
		
		//a3 : Animal의 필드와 메소드만 접근
		a3.name = "호랑이4";
		a3.age = 7;
		a3.eat();
...
//		}
		...
		//t6 : TigerChild타입 (Animal, Tiger, TigerChild 필드와 메소드 모두 접근가능)
		t6.age = 2;	//Animal
//		t6.tigerSound = "어흥어흥";	//Tiger
		t6.TigerChildSound = "어흥";	//TigerChild
		
		//t6를 (TigerChild) ==> Animal 
