...
//3. 매개변수로 받아서 처리 : 인터페이스를 구현한 클래스 (없음), 메소드의 인풋 매개변수
//	 인터페이스를 전송 후 출력
...
public class Anonimous_Class03 {
	...
	public static void main(String[] args) {
		...
		//3. 인터페이스를 구현한 클래스 (없음) , 참조 변수를 생성 후 참조변수를 매개변수로 입력 후 출력
		...
		c.cde(new A () {
			@Override
			public void abc() {
				System.out.println("4. 참조변수 없이 사용해서 메소드 매개 변수로 입력 후 출력");
