...
//제너릭 클래스 : 다양한 타입을 저장 할 수 있는 클래스
	...
	//<T>에 들어오는 타입은 객체형 타입만 들어와야함. wrapper class를 사용해야함.
...
public class SingleGenericArgument {
	...
	public static void main(String[] args) {
		...
		pen1.set(new Pencil());		//setter를사용해서 pencil 객체를 주입
		System.out.println(pen1.get().pencil); //getter를 사용해서 pencil 객체화 가져옴
