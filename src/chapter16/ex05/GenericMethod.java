...
class GenericMethods {
	...
	//제너릭 메소드  : 일반 클래스 내부에 제네릭 타입의 메소드
	//접근제어자 <외부에서 타입지정> 리턴타입 메소드명 (타입 변수)
	//다양한 타입의 값을 리턴으로 되돌려주는 메소드
	public <T> T method1 (T t) {
		return t;
	}
	
	//동일한 타입의 두 값을 인풋 받아서 같으면 True, 다르면 False를 리턴시켜줌
	//제너릭에 넣는 타입변수 T에 올 수 있는 것은 기본타입은 넣을 수 없음. wrapper class만 올 수 있음.
...
public class GenericMethod {
	...
	public static void main(String[] args) {
		...
		String str2 = gm.method1("하세요");	//뒤의 인풋값으로 타입을 유추할 수 있는경우 생략가능
