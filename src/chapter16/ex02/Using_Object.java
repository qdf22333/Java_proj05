...
//모든 객체는 Object를 상속하고 있음.
//모든 객체는 Object 타입으로 모두 타입 변환할 수 있음.
	//Object 타입으로 저장된 객체를 가져와서 사용하기 위해서는 매번 다운캐스팅이 필요.
...
public class Using_Object {
	...
	public static void main(String[] args) {
		//1. Goods 를 사용해서 Apple 객체를 저장 후 가져오기.
		Goods goods1 = new Goods();
		goods1.setObject(new Apple());	//Apple 객체를 생성해서 setter주입.
		
		//Getter를 사용해서 값을 가져올 때 다운캐스팅해서 가져와야함.
		...
		//2. Goods 를 사용해서 Pencil 객체를 저장 후 가져오기. 
