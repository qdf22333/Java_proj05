...
//java/lang 패키지 하위의 클래스는 생략가능 (Object, String, Integer...) 
...
public class CreateListObject {
	...
	public static void main(String[] args) {
		// 참고로 알아둠. 몰라도 상관없는 내용.
		//1. ArrayList
		List<Integer> aList1 = new ArrayList();	//내부적으로 메모리공간을 10개를 확보
		List<Integer> aList2 = new ArrayList(30);	//내부적으로 초기 메모리공간 방 30개를 생성
		...
		//3. LiskedList
		List<Integer> aList5 = new LinkedList();	//capacity 60
//		List<Integer> aList6 = new LinkedList(60);	//오류발생, 초기설정시 오류발생
		
		//컬렉션은 자동으로 방 크기가 (무한정) 늘어나고 줄어듬.
		//Array.aList()를 사용해서 값을 넣을 경우 방크기가 고정되어서 늘어나거나 줄어들지 않음.
