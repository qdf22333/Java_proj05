...
public class ArrayListMethod {
	...
	public static void main(String[] args) {
		...
		//1. add (E element) : List에 값을 추가할 때 : ArrayList, Vectory, LinkedList
			//마지막 방에 값이 들어감
		aList1.add(3);
		aList1.add(4);
		aList1.add(5);
		...
		aList1.add(1,6);	//방 번호 1ㅔ 6값을 넣겠다.
		
		System.out.println(aList1);
		
		//3. addAll (다른 리스트객체 ):다른 컬렉션의 모든 내용을 합쳐서 출력
		...
		Integer[] int1 = aList3.toArray(new Integer[0]);	
			//0 : 변환할 배열 방의 개수인데, 컬렉션의 배열방보다 작게설정된 경우 
			//컬렉션에 저장된 것에 맞추어 처리 
