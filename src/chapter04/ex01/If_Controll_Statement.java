...
public class If_Controll_Statement {
	...
	public static void main(String[] args) {
		...
		System.out.println("========{조건이 참일 때 실행문} , {} 생략가능 ===========");
			//if 조건에서 실행문이 하나일 때 중괄호 {} 생략가능
		if (value1 < 3) 
			System.out.println("실행3");	//실행문 1개만 {} 생략되어서 처리될 수 있다.
		...
		if (value3 > 90) {
			...
			System.out.println("B 학점");		//if 문을 빠져나온다. 실행 후 탈출
		} else if (value3 >= 70) {
