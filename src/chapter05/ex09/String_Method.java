...
public class String_Method {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.indexOf('a')); 	//문자 a가 저장된 방 번호를 출력 : 7
		System.out.println(str1.lastIndexOf('a'));	//9
		
		System.out.println(str1.indexOf('a', 8));	//8번 부터 검색 a를 검색 : 9  -->
		System.out.println(str1.lastIndexOf('a', 8));	//8번 부터 검색 a를 검색 :7 <--
	...
	//	String str3 = 2.3;	//오류 발생 : 2.3 ( double형 데이터를 String에 저장시 오류 )
	...
	//	String str4 = true;			//boolean 타입을 String 변수에 저장시 오류
		...
		String str7 = "안녕" + 3;			//안녕 3, 3이 String형으로 자동변환
		...
		//substring (0, 5) : 0번째 방 부터 5번 방 까지 잘라오삼
		System.out.println(str13.substring(0, 4));	//0번에서 시작해서 4번 방 앞까지 짤림
		...
		//6. 문자열의 내용비교 ( equals (), equalsIgnoreCase() )
			...
			//equalsIgnoreCase() : Heap의 값 비교, 대소문자를 체크하지 않음
		String str20 = new String ("Java");
		String str21 = new String ("Java");
		String str22 = new String ("java");
		
		//== : Stack 메모리의 참조 주소비교.
		System.out.println(str20 == str21);	//f
		System.out.println(str20 == str22);	//f
		System.out.println(str21 == str22);	//f
		System.out.println("=================");
		
		//equals() : 대소문자를 체크하면서 Heap의 값을 비교.
		System.out.println(str20.equals(str21));	//t
		System.out.println(str20.equals(str22));	//f
		System.out.println(str20.equalsIgnoreCase(str22));	//t
