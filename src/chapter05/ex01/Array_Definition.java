...
public class Array_Definition {
	...
	public static void main(String[] args) {
		...
		배열 - 하나의 배열 변수에 많은값을 저장할 수 있다.
			- 배열의 특징 :1. 배열변수의 동일한 자료형의 값만 저장할 수 있다. (int, long, double ..)
						2. 배열은 방의 갯수가 정의되면 수정이 불가능
			- 배열의 초기값을 할당하지 않더라도 강제로 초기값이 할당
			- Heap 공간에는 값이 반드시 할당되어야함
		...
		*/
		...
		//변수를 선언 후 초기값을 할당하지않고 사용하면 오류발생
		int c;
		int d;
		//int sum = c+d;		//오류발생 : c, d 변수에 초기값을 넣지않고 사용했으므로 오류
		
		System.out.println("=====배열: 1. 선언방법 1================");
		...
		//	index:방의 번호 , 0 , 1, 2, ...
			...
			//배열에 값 할당
			array1[0] = 55;		//array1 의 Heap영역의 주소 0번째 방에 55를 넣어라
			array1[1] = 66;
			array1[2] = 77;
			//배열의 값 출력
		...
		//int [] array6 = new int[5] { 10,20,30,40,50};	
			//오류 발생 : 선언과 동시에 배열 변수에 값 할당할 때 방크기를 지정하면 오류발생
		...
		//선언과 값 을 분리시 오류발생
		int [] array9;
		//array9 = {112,222,333,444,555};	//오류발생
			// 대괄호 앞에 new int[] 넣으면 됨
