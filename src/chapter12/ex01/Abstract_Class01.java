...
abstract class Animal{	//추상 클래스, 추상메소드를 1개라도 포함되면 
	String name;
	int age;
	
	Animal (){}
	
	//추상 메소드 : {}, 실행블락이 없고 선언만 된 메소드
		//하위 클래스에서 추상 메소드를 반드시 구현해야한다.
	...
	// Object 클래스의 메소드 : 객체를 출력했을 때 객체의 Heap의 참조주소 출력하지 않고 필드의 값을 출력
	@Override
