...
interface A {
	//static 메소드 : public 생략됨. 객체생성없이 바로 호출 가능
		//구현코드가 있는 메소드
	static void abc() {
