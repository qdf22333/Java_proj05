...
public class Default_Interface {
	...
	public static void main(String[] args) {
		// interface : ***인터페이스의 모든 필드와 메소드는 public이 생략되어 있음 ***
			// 구현된 클래스에서 메소드를 오버라이딩할 때 public 키가 들어가있어야함.
		// 모든 필드는 : public static final
		// 모듬 메소드는 추상 메소드 이어야 한다. public abstract
		...
		//default : 인터페이스에서 구현부가 있는 메소드
				...
				//오버라이딩도 가능
				//새로운 기능을 추가할 때 허위의 구현된 클래스의 오류없이 적용가능 하도록 함
