...
public class EX03 {
	...
	public static void main(String[] args) {
		// 배열 a : 7의 배수 저장하는 배열 : 1 ~ 500 까지
		int []a = new int [500/7];
		System.out.println(a.length);	//방의 갯수 : 71 , 방 번호 : 0 ~ 70 
		...
		//배열 b의 내용을 출력
		System.out.println(b.length);		//방의 갯수 : 55, 방 번호 : 0 ~ 54
		System.out.println(Arrays.toString(b));
		
		System.out.println("========54번째 방========");
