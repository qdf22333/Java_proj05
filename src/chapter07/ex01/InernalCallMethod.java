...
public class InernalCallMethod {
	...
	//main : 메소드 <== static 이 붙어잇는 메소드
	public static void main(String[] args) {
		// 클래스 내부에서 다른 메소드 호출
			//main 메소드는 메소드 이름 앞에 public : 다른 패키지에서 호출이 가능
			//static : 인스턴스화 하지 않고 사용가능. 객체를 생성하지 않고 사용가능하다
	

		//print 메소드 호출 (객체 생성없이 바로 호출이 가능)
		print (); 
		System.out.println("=======================");
	...
	//메소드 이름 앞에 static 키를 넣으면 객체 생성없이 호출이 가능
	
	//void 외에는 나머지 return 해줘야함
	public static void print() {
		System.out.println("안녕");
	
	}
	
	//정수를 인풋받아 2배로 생성해서 리턴
