...
class Aa {	//this() 를 사용하지 않고 생성자 작성
	...
	Aa(int a, int b) {		//매개변수로 정수 2개를 인풋받아서 m2에 값을 할당 
		m1 = a;
		m2 = b;
		m3 = 3;
		m4 = 4;
	...
	Aa(int a, int b, int c) {		//매개변수로 정수 3개를 인풋받아서 m3에 값을 할당 
		m1 = a;
		m2 = b;
		m3 = c;
		m4 = 4;
	...
	Aa(int a, int b, int c, int d) {		//매개변수로 정수 4개를 인풋받아서 m4에 값을 할당 
		m1 = a;
		m2 = b;
		m3 = c;
		m4 = d;
...
public class This_Method02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("=====Bb 클래스에서 매개변수 정수 1개인 생성자 호출=====");
		Bb b2 = new Bb(10);
		b2.print();
		
		System.out.println("=====Bb 클래스에서 매개변수 정수 2개인 생성자 호출=====");
		Bb b3 = new Bb(10,20);
		b3.print();
		
		System.out.println("=====Bb 클래스에서 매개변수 정수 3개인 생성자 호출=====");
		Bb b4 = new Bb(10,20, 30);
		b4.print();
		
		System.out.println("=====Bb 클래스에서 매개변수 정수 4개인 생성자 호출=====");
